...
public class UpcomingListAdapter extends RecyclerView.Adapter<UpcomingListAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            circle_btn = (ImageView) v.findViewById(R.id.circle_bttn_1);
            time1 = (TextView) v.findViewById(R.id.time_1_1);
            tvName = (TextView) v.findViewById(R.id.tv_name_1);
            tvPhone = (TextView) v.findViewById(R.id.tv_phone_1);
            date1 = (TextView) v.findViewById(R.id.date_1_1);
            card_view = (CardView) v.findViewById(R.id.LinearLayout1_1);
    ...
    public UpcomingListAdapter(Context context, ArrayList<MedicineItem> list, OnMedicineItemClickListener listener) {
    ...
    @Override
    public UpcomingListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View v = LayoutInflater.from(context).inflate(R.layout.upcomig_list_activity, parent, false);
    ...
    @Override
    public void onBindViewHolder(final UpcomingListAdapter.ViewHolder holder, int position) {
        ...
        ((CardView) holder.card_view).setCardBackgroundColor(Color.YELLOW);
    ...
    @Override
    public void onViewDetachedFromWindow(UpcomingListAdapter.ViewHolder holder) {
